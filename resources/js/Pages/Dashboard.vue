...
<template>
    <AppLayout title="Dashboard">
        <div class="max-w-7xl mx-auto sm:px-4 lg:px-6">
            <div class="rounded-md bg-green-50 p-2" v-if="!exceptions.length">
                <div class="flex">
            ...
            <Card v-if="exceptions.length">
                ...
                <ul class="divide-y divide-gray-200">
                    <li v-for="exception in exceptions" :key="exception.id">
                        <inertia-link :href="route('exceptions.show', {id: exception.project_id, exception: exception })"
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600">
                                    <Badge success v-if="exception.status === 'Fixed'">{{ exception.status }}</Badge>
